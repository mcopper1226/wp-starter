...
export default function thumbnail_slideshow() {
  var ThumbSlideshow = function(element) {
    this.element = element;
    this.slideshow = this.element.getElementsByClassName("slideshow")[0];
    this.slideshowItems = this.slideshow.getElementsByClassName(
      "js-slideshow__item"
    );
    ...
    this.carouselListWrapper = this.carousel.getElementsByClassName(
      "thumbslide__nav"
    )[0];

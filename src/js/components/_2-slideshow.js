...
export default function slideshow() {
  ...
  function resetAnimationEnd(slideshow, item) {
    setTimeout(function() {
      ...
      Util.removeClass(
        item,
        'slideshow__item--slide-out-left slideshow__item--slide-out-right slideshow__item--slide-in-left slideshow__item--slide-in-right'
      );
  ...
  function getExitItemClass(bool, oldIndex, newIndex) {
    ...
    if (bool) {
      className =
        bool == 'next'
          ? 'slideshow__item--slide-out-right'
          : 'slideshow__item--slide-out-left';
    } else {
      className =
        newIndex < oldIndex
          ? 'slideshow__item--slide-out-left'
  ...
  function getEnterItemClass(bool, oldIndex, newIndex) {
    ...
    if (bool) {
      className =
        bool == 'next'
          ? 'slideshow__item--slide-in-right'
          : 'slideshow__item--slide-in-left';
    } else {
      className =
        newIndex < oldIndex
          ? 'slideshow__item--slide-in-left'

...
export default function slideshow_preview_mode() {
  ...
  function initSlideshowEvents(slideshow) {
    ...
    if (slideshow.options.navigation) {
      ...
      for (var i = 0; i < slideshow.items.length; i++) {
        var className =
            i == slideshow.selectedSlide
              ? 'class="slideshow-pm__nav-item slideshow-pm__nav-item--selected js-slideshow-pm__nav-item"'
              : 'class="slideshow-pm__nav-item js-slideshow-pm__nav-item"',
          navCurrentLabel =
            i == slideshow.selectedSlide
  ...
  function navigateSlide(slideshow, event, keyNav) {
    ...
    if (
      keyNav &&
      target &&
      !Util.hasClass(target, "slideshow-pm__nav-item--selected")
    ) {
  ...
  function resetSlideshowNav(slideshow, newIndex, oldIndex) {
    if (slideshow.navigation) {
      Util.removeClass(
        ...
        "slideshow-pm__nav-item--selected"
      );
      Util.addClass(
